...
const CapitalForm = ({setFieldValue,handleChange,handleBlur, values,handleSubmit,modalTransaction, setModalTransaction}) => {
          ...
          <View style={{width:'100%',flex: 1, justifyContent:'center',alignItems:'center', marginBottom:10, }}>
            ...
            <TouchableOpacity style={styles.textInput} onPress={() => {
              ...
              pickImageOnly(isUpdate, setImg)
                ...
                <View style={{flexDirection:'row', justifyContent:'space-between', paddingRight:10}}>
                    <Text style={{color:'#474747'}}>Unggah Bukti Modal Masuk</Text>   
