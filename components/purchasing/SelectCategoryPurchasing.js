...
import PurchasingCategory from './PurchasingCategory';
import { windowHeigth, windowWidth } from '../../utils/DimensionSetup'

const SelectCategoryPurchasing = ({modalCategoryVisible, setModalCategoryVisible, setCategory}) => {
        ...
        <View style={styles.centeredView}>
            ...
            <View style={styles.lowerWrap}>
                { purchaseCategory.map((item, i) => {
                    return(
                    <PurchasingCategory item={item} key={item.id} setCategory={setCategory} modalCategoryVisible={modalCategoryVisible} setModalCategoryVisible={setModalCategoryVisible}/>
                    )
                })}
            </View>  
        </View>
...
export default SelectCategoryPurchasing
