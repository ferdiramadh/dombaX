...
const PurchaseItem = () => {
    ...
    const sortData = purchasingData.sort((a, b) => {
        ...
        Print.printAsync({
            ...
            <body>
                ...
                <div style="margin: auto ;width: 80%;background: orange">
                    ...
                    <h2>Harga Beli: ${item.hargaBeli}</h2>
                    <h3>Tanggal Pembelian: ${item.tanggalBeli}</h3>
                </div>
    ...
    return (
        <View>
            {   purchasingData.length !== 0? sortData.map((item, i) => {
                return(
                        ...
                        <View style={styles.rightSection}>
                            ...
                            <View style={styles.dombaInfo}>
                                <View style={styles.leftDombaInfo}>
                                    <Text style={[styles.infoData,item.status !== 'Lunas'? {color:'#FA0E0E'}:{color:'#0EFA33'}]}>{formatToCurrency(parseInt(item.hargaBeli)*parseInt(item.kuantitas))}</Text>
                                    <Text style={{fontSize: 16 ,color:'black'}}>{item.tanggalBeli}</Text>
                                </View>
