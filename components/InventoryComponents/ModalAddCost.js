...
import FormCost from '../cost/FormCost'

const ModalAddCost = ({modalCostVisible, setModalCostVisible}) => {
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
                ...
                <View style={styles.formSection}>
                  <FormCost modalCostVisible={modalCostVisible} setModalCostVisible={setModalCostVisible}/>
                </View>
